...
// $Id: MakeTransientTree.h 653309 2015-03-11 13:54:46Z krasznaa $
...
namespace xAOD {
   ...
   /// Function cleaning up the managed memory after the metadata tree code
   ///
   /// The function can be used to explicitly delete all objects created by the
   /// MakeTransientMetaTree functions on the heap.
   ///
