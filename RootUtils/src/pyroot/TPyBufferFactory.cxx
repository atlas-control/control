...
//- instance handler ------------------------------------------------------------
RootUtils::TPyBufferFactory* RootUtils::TPyBufferFactory::Instance()
{
// singleton factory
...
RootUtils::TPyBufferFactory::TPyBufferFactory()
{
...
PyObject* RootUtils::TPyBufferFactory::PyBuffer_FromMemory( type* address, Py_ssize_t size )\
{                                                                               \
   size = size < 0 ? INT_MAX : size;                                            \
   PyObject* buf = PyBuffer_FromReadWriteMemory( (void*)address, size );        \
   if ( buf ) {                                                                 \
      volatile void* obj = (void*)&Py##name##Buffer_Type;                       \
   ...
   return buf;                                                                  \
                                                                                ...
                                                                                \
PyObject* RootUtils::TPyBufferFactory::PyBuffer_FromMemory( type* address, PyObject* scb )\
{                                                                               \
