...
public:
  ...
  //HACK
  virtual StatusCode runAlgorithm( std::string AlgName, EventContext* eventContext );
  virtual StatusCode pushSubEventsAndSuspend( std::vector< EventContext* > subEventContexts );
...
private:
  ...
  //Suspend a slot BEN
  std::vector<bool> m_suspendPlease;
  ...
  StatusCode isSuspended(int iSlot); //BEN
